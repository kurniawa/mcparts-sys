...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('contact_numbers', function (Blueprint $table) {
            ...
            $table->string("contact_type", 50)->nullable(); // e.g., mobile, home, office, fax, etc.
            $table->string("contact_status", 50)->nullable(); // e.g., active, inactive, etc.
            $table->string("contact_order", 50)->nullable(); // Order of the contact, e.g., 1 for primary, 2 for secondary, etc.
